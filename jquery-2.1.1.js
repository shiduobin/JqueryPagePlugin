...
function curCSS( elem, name, computed ) {
	...
	// Support: IE9
	// getPropertyValue is only needed for .style('filter') in IE9, see #12537
	if ( computed ) {
...
jQuery.extend({
	...
	cssProps: {
		// normalize float style property
		"float": "cssFloat"
	},
...
// rather than make the style module depend on the offset module, we just check for it here
